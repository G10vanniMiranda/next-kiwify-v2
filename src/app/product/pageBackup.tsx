        ...
        <div className="bg-white rounded-md h-[598px] w-96 flex flex-col items-center gap-4 border-2">
          <form className=" flex flex-col w-96 m-4 h-[350px] gap-2 p-5">
            ...
            <button
              ...
              className={`${btnEntrar} p-2 w-auto text-white text-md rounded-md font-semibold cursor-pointer"
              `}
            >
              Adicionar
            </button>
          ...
          <div className="flex flex-col w-96 m-4 h-[250px] gap-2 p-5 ">
            {data.map((item) => (
              <div
                key={item.id}
                className="bg-slate-800 p-2 text-white rounded-md cursor-pointer hover:bg-transparent hover:border hover:text-black"
              >
                <p>{item.name}</p>
